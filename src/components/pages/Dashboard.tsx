          ...
          <div className="flex items-start gap-3">
            ...
            <div className="flex-1 text-sm">
              ...
              <p className="text-blue-800">
                This platform is designed for educational purposes. All community discussions are sourced from{' '}
                <a 
                  href="https://connect.ntminfo.org/communities/globalforum" 
                  target="_blank" 
                  rel="noopener noreferrer"
                  className="underline font-medium hover:text-blue-900"
                >
                  NTM Info & Research Global Forum
                </a>
